...
class PaletteMixin:
    ...
    def show_about(self) -> None:
        ...
        QMessageBox.about(
            ...
            "workstation.<br><br>"
            "A scriptable spreadsheet with 400+ formula functions — math and "
            "engineering, statistics and distributions, financial, text, date/time, "
            "database, dynamic arrays (XLOOKUP / UNIQUE / SORT / FILTER / SEQUENCE), "
            "and a full RF formula set — plus built-in analysis: SQL "
