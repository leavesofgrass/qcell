"""TI-83-style graphing-calculator engine for abax (pure-stdlib).
...
Expression evaluation reuses :mod:`abax.core.graphing`, whose
:func:`~abax.core.graphing.compile_expr` already sandboxes the namespace and
