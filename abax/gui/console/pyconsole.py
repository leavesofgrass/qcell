...
User code runs in a SEPARATE process (:mod:`abax.console_worker`, via
:class:`~abax.gui.console_bridge.ConsoleBridge`) **on a background thread**, so a
...
# Identifiers bound in the console namespace (see abax.core.console_ns); offered
